...
** Dissimilarity 
   ...
   + IND_IDS information :: 
        ...
        |-----------------------------------------+------------------+---------------------------------------------------------------------------------------------|
        | All                                     | DisT.IS          | \(\frac{1}{2} \sum_a\mid \frac{T.IS_a}{T.IS} - \frac{E.IS_a}{E.IS} \mid\)                   |
        | Female                                  | DisT.IS.F        | \(\frac{1}{2} \sum_a\mid \frac{T.IS.F_a}{T.IS.F} - \frac{E.IS_a}{E.IS} \mid\)               |
        | Teachers aged 50 and above              | DisT.IS.Ag50p    | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Ag50p_a}{T.IS.Ag50p} - \frac{E.IS_a}{E.IS} \mid\)       |
        | Newly recruited                         | DisNT.IS         | \(\frac{1}{2} \sum_a\mid \frac{NT.IS_a}{NT.IS} - \frac{E.IS_a}{E.IS} \mid\)                 |
        | Math                                    | DisT.IS.Math     | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Math_a}{T.IS.Math} - \frac{E.IS_a}{E.IS} \mid\)         |
        | Reading and writing                     | DisT.IS.Read     | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Read_a}{T.IS.Read} - \frac{E.IS_a}{E.IS} \mid\)         |
        | Trained teachers                        | DisT.IS.trained  | \(\frac{1}{2} \sum_a\mid \frac{T.IS.trained_a}{T.IS.trained} - \frac{E.IS_a}{E.IS} \mid\)   |
        | Newly recruited and trained teachers    | DisNT.IS.trained | \(\frac{1}{2} \sum_a\mid \frac{NT.IS.trained_a}{NT.IS.trained} - \frac{E.IS_a}{E.IS} \mid\) |
        | Teachers with ISCED level+1 or less     | DisT.IS.EA.ISp1m | \(\frac{1}{2} \sum_a\mid \frac{T.IS.EA.ISp1m_a}{T.IS.EA.ISp1m} - \frac{E.IS_a}{E.IS} \mid\) |
        | Teachers with ISCED level+2 or more     | DisT.IS.EA.ISp2p | \(\frac{1}{2} \sum_a\mid \frac{T.IS.EA.ISp2p_a}{T.IS.EA.ISp2p} - \frac{E.IS_a}{E.IS} \mid\) |
        | Teachers with less than 2 years of exp  | DisT.IS.Exp2m    | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Exp2m_a}{T.IS.Exp2m} - \frac{E.IS_a}{E.IS} \mid\)       |
        | Teachers with more than 10 years of exp | DisT.IS.Exp10p   | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Exp10p_a}{T.IS.Exp10p} - \frac{E.IS_a}{E.IS} \mid\)     |
        | Private teachers                        | DisT.IS.Pr       | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Pr_a}{T.IS.Pr} - \frac{E.IS_a}{E.IS} \mid\)             |
        | Non-permanent teachers, total           | DisT.IS.Fix      | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Fix_a}{T.IS.Fix} - \frac{E.IS_a}{E.IS} \mid\)           |
        | Non-permanent teachers, private         | DisT.IS.Pr.Fix   | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Pr.Fix_a}{T.IS.Pr.Fix} - \frac{E.IS_a}{E.IS} \mid\)     |
        | Non-permanent teachers, public          | DisT.IS.Pu.Fix   | \(\frac{1}{2} \sum_a\mid \frac{T.IS.Pu.Fix_a}{T.IS.Pu.Fix} - \frac{E.IS_a}{E.IS} \mid\)     |
        |-----------------------------------------+------------------+---------------------------------------------------------------------------------------------|
