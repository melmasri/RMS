...
#+latex: \\
   #+ATTR_LATEX:  :align |l|l|l|c|
        ...
        |----------+---------------+--------------------------------------------------------------------+-------|
        where =cat= is  =Exp1t2=,  =Exp3t5=, =Exp6t10=,  =Exp11t15= and  =Exp15p=.  and Midpoints (MP) are =[Exp1t2 = 1.5, Exp3t5 = 4, Exp6t10 = 8, Exp11t15 = 13, Exp15p = 15]=, and based on the following:  
#+latex: \\
   #+ATTR_LATEX:  :align |l|c|c|c|c|c|c|
...
#+latex: \\
   #+ATTR_LATEX:  :align |l|l|l|c|                       
     ...
     |--------------------------------+------------+------------------------------------------------+-------|
     | Lower secondary or Less        | EA.2mPT.IS | T.IS.EA.2m / T.IS                              | No    |
     | Upper secondary                | EA.3PT.IS  | T.IS.EA.3 / T.IS                               | No    |
     | Post secondary                 | EA.4PT.IS  | T.IS.EA.4 / T.IS                               | No    |
     | At least tertiary              | EA.5pPT.IS | T.IS.EA.5 + T.IS.EA.6+T.IS.EA.7+T.IS.EA.8/T.IS | No    |
     | Unknown                        | EA.ukPT.IS | T.IS.EA.uk / T.IS                              | No    |
     |--------------------------------+------------+------------------------------------------------+-------|
